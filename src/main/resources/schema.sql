...
(
    ...
    created TIMESTAMP NOT NULL,
    user_id BIGINT NOT NULL,
    CONSTRAINT fk_item_requests_users FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);

ALTER TABLE items ADD CONSTRAINT fk_items_item_request FOREIGN KEY (item_request_id) REFERENCES item_requests(id);
